<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewFullStock.aspx.cs" Inherits="victuling_WordRoom.ViewFullStock" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <tr>
        <td class="style1">
            <strong style="text-align: left">View All Stock</strong></td>
        <td>
            &nbsp;</td>
        <td>
            &nbsp;</td>
