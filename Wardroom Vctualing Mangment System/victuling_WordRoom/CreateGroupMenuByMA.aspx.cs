...
{
    public partial class CreateGroupMenuByMA : System.Web.UI.Page
    {
        ...
        private void SetInitialRow()
        {
            ...
            dt1 = itemObject.GetGroupMenu(strConnString, dateMenuDate.SelectedDate.ToString(), cmbDescription.SelectedValue.ToString(), wardRoomCode.ToString().Trim(), ddlGroupMenu.SelectedValue.ToString());
        ...
        public void Bind_T_DailyMenu()
        {
            ...
            dtUpdateSportsGrid = itemObject.GetGroupMenu(strConnString, dateMenuDate.SelectedDate.ToString(), cmbDescription.SelectedValue.ToString(), wardRoomCode.ToString().Trim(), ddlGroupMenu.SelectedValue.ToString());
            if (dtUpdateSportsGrid.Rows.Count > 0)
            {
                k = 0;
        ...
        public void bindserchdatagv()
        {
            ...
            //dtUpdateSportsGrid.Clear();
            dtUpdateSportsGrid = itemObject.GetMenu(strConnString, dateMenuDate.SelectedDate.ToString(), cmbDescription.SelectedValue.ToString(), wardRoomCode.ToString().Trim(), ddlGroupMenu.SelectedValue.ToString());
        ...
        public void AddMenuItem_T_DailyMenu()
        {
            ...
            try
            {
                ...
                lblError1.Text = "Insert Menu Item to List!";
