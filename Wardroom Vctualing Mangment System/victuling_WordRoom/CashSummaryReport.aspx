<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CashSummaryReport.aspx.cs" Inherits="victuling_WordRoom.CashSummaryReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table style="width:100%;">
        <tr>
            <td colspan="3">
                <strong><span class="style2">Cash Summary Report</span></strong></td>
        </tr>
        <tr>
            <td class="style3">
                &nbsp;</td>
