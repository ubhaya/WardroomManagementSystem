...
<telerik:RadScriptManager ID="RadScriptManager1" Runat="server">
    ...
    <table style="width:100%;">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtTeaCost" runat="server" Width="245px"></asp:TextBox>
            </td>
            <td>
                &nbsp;
            </td>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtPlainTeaCost" runat="server" Width="245px"></asp:TextBox>
            </td>
            <td>
                &nbsp;
            </td>
        ...
        <tr>
            ...
            <td>
                <telerik:RadButton ID="btnSave" runat="server" onclick="btnSave_Click" 
                    Text="Add Monthly Tea Cost" Width="200px">
                </telerik:RadButton>
            </td>
            <td>
