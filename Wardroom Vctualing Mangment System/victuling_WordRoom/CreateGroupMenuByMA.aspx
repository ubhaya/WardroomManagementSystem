<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CreateGroupMenuByMA.aspx.cs" Inherits="victuling_WordRoom.CreateGroupMenuByMA" %>
    ...
    <table style="width: 100%;">
        <tr>
            <td class="style1" colspan="2">
                <strong>Create Group Menu</strong></td>
            <td>
                &nbsp;</td>
        </tr>
        <tr>
...
&nbsp;:</td>
        ...
        <tr>
            <td class="style2">
                <asp:Label ID="Label9" runat="server" Text="Wardroom  :" Visible="False"></asp:Label>
            &nbsp;</td>
            <td>
                <telerik:RadComboBox ID="ddlWardroom0" Runat="server" 
                    onselectedindexchanged="ddlWardroom0_SelectedIndexChanged" Visible="False">
                </telerik:RadComboBox>
