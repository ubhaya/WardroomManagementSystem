...
{
    public partial class ItemSummarySale : System.Web.UI.Page
    {
        ...
        public void getMainMenu()
        {
            ...
            command.CommandText = "[VICTULING_DailySaleSummery_price]";
        ...
        public void deleteAllData()
        {
            ...
            command.Connection = con;
            command.CommandType = CommandType.StoredProcedure;
            command.CommandText = "VICTULING_Delete_DailySaleSummary_withPrice";
        ...
        public void SaveMainMenu()
        {
            ...
            dt = itemObject.GetDailyItemSummaryMenue_withPrice(strConnString, wardroomCode, selectdate);
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                try
                {
                    ...
                    sqlcmd.CommandText = "VICTULING_InsertDailyItemSummary_price";
        ...
        public void SaveExtra()
        {
            ...
            dt = itemObject.GetDailyItemSummaryExtra_withPrice(strConnString, wardroomCode, selectdate);
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                itemMessurment = dt.Rows[i]["itemMessurment"].ToString();
                unitPrice = dt.Rows[i]["unitPrice"].ToString();
                price = dt.Rows[i]["totalCost"].ToString();
                reason = dt.Rows[i]["reason"].ToString();
                groupMenue = dt.Rows[i]["GroupMenu"].ToString();
                // serial = dt.Rows[i]["SlNo"].ToString();
        ...
        public void SaveParty()
        {
            ...
            dt = itemObject.GetDailyItemSummaryParty_withPrice(strConnString, wardroomCode, selectdate);
        ...
        public void SaveDepreciation()
        {
            ...
            dt = itemObject.GetDailyItemSummaryDepreciation_withPrice(strConnString, wardroomCode, selectdate);
        ...
        public void getTotal()
        {
            ...
            command.Connection = con;
            command.CommandType = CommandType.StoredProcedure;
            command.CommandText = "VICTULING_TotalDailySummery_NEW_withPrice";
