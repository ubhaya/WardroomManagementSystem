...
{
    public partial class IndividualSale : System.Web.UI.Page
    {
             ...
             for (int i = 0; i < grdMedal.Rows.Count; i++)
             {
                 try
                 {
                     ...
                     if (decimal.Parse(saleQty.Text.ToString()) >= decimal.Parse(stockQty.Text.ToString()))
                     {
                         //if (saleQty.Text != "")
                         //{
                         decimal saleQtyperPerson = (decimal.Parse(stockQty.Text.ToString()) / officerCount);
                         Double cost = (((Convert.ToDouble(stockQty.Text)) / officerCount) * (Convert.ToDouble(unitPrice.Text)));
                     ...
                     if (balanceQty > 0)
                     {
                         ...
                         for (int x = i + 1; x < grdMedal.Rows.Count; x++)
                         {
                             if (balanceQty > 0)
                             {
                                 ...
                                 RadTextBox itemId1 = (RadTextBox)grdMedal.Rows[i].FindControl("txtItemCode");
                                 RadTextBox saleQty1 = (RadTextBox)grdMedal.Rows[i].FindControl("txtSaleQty");
                                 RadTextBox messurment1 = (RadTextBox)grdMedal.Rows[i].FindControl("txtMesu");
                                 RadTextBox unitPrice1 = (RadTextBox)grdMedal.Rows[i].FindControl("txtPrice");
                                 RadTextBox recevedFrom1 = (RadTextBox)grdMedal.Rows[i].FindControl("txtFrom");
                                 RadTextBox Id1 = (RadTextBox)grdMedal.Rows[i].FindControl("txtID");
                                 RadTextBox stockQty1 = (RadTextBox)grdMedal.Rows[i].FindControl("txtOnChargeQty");
                                 ...
                                 if (itemId.Text == itemId1.Text)
                                 {
                                     ...
                                     cmd1.CommandText = "[VICTULING_insert_T_DailyExtraSales]";

                                     cmd1.Parameters.AddWithValue("@saleDate", dateSaleDate.SelectedDate.ToString());
                                     cmd1.Parameters.AddWithValue("@itemCode", itemId1.Text);
                                     cmd1.Parameters.AddWithValue("@itemId", Id1.Text);

                                     //decimal saleQtyperPerson = (decimal.Parse(balanceQty.ToString()) / officerCount);
                                     //Double cost = (((Convert.ToDouble(balanceQty.ToString())) / officerCount) * (Convert.ToDouble(unitPrice1.Text)));

                                     if (double.Parse(stockQty1.Text.ToString()) >= balanceQty)
                                     {
                                         decimal saleQtyperPerson = (decimal.Parse(balanceQty.ToString()) / officerCount);
                                         cmd1.Parameters.AddWithValue("@saleQty", saleQtyperPerson.ToString());
                                         Double cost1 = (((Convert.ToDouble(balanceQty.ToString())) / officerCount) * (Convert.ToDouble(unitPrice1.Text)));
                                         cmd1.Parameters.AddWithValue("@TotalCost", cost1);
                                     }
                                     else
                                     {
                                         decimal saleQtyperPerson = (decimal.Parse(stockQty1.Text) / officerCount);
                                         cmd1.Parameters.AddWithValue("@saleQty", saleQtyperPerson.ToString());
                                         Double cost1 = ((double.Parse(unitPrice1.Text)) * (double.Parse(stockQty1.Text) / officerCount));
                                         cmd1.Parameters.AddWithValue("@TotalCost", cost1);
                                     }
                                     ...
                                     //cmd.Parameters.AddWithValue("@TotalCost", cost.ToString());
                                     cmd1.Parameters.AddWithValue("@recevedFrom", recevedFrom1.Text);
                                     cmd1.Parameters.AddWithValue("@reasonCode", ddlReason.SelectedValue.ToString());
                                     cmd1.Parameters.AddWithValue("@groupMenuCode", ddlGroupMenu.SelectedValue.ToString());
                                     cmd1.Parameters.AddWithValue("@offNo", offNo);
                                     cmd1.Parameters.AddWithValue("@officerSailor", "O");
                                     cmd1.Parameters.AddWithValue("@serviceType", "");
                                     cmd1.Parameters.AddWithValue("@currentBase", Session["wardRoomName"].ToString());
                                     cmd1.Parameters.AddWithValue("@permantBase", '0');
                                     cmd1.Parameters.AddWithValue("@wardroomCode", Session["wardRoomCode"].ToString());
                                     ...
                                     cmd1.Parameters.AddWithValue("@takenBy", "");
                                     cmd1.Parameters.AddWithValue("@offNoSailor", "");
                                     cmd1.Parameters.AddWithValue("@serviceTypeSailor", "");
                                     cmd1.Parameters.AddWithValue("@osSailor", "");
                                     cmd1.Parameters.AddWithValue("@rankRate", "");
                                     cmd1.Parameters.AddWithValue("@vegNonVeg", ddlVegi.SelectedValue.ToString());
                     ...
                     else
                     {
                         ...
                         Double cost1 = (((Convert.ToDouble(saleQty.Text)) / officerCount) * (Convert.ToDouble(unitPrice.Text)));
                         ...
                         cmd.Parameters.AddWithValue("@saleQty", saleQtyperPerson.ToString());
                         cmd.Parameters.AddWithValue("@unitPrice", unitPrice.Text);
                         cmd.Parameters.AddWithValue("@TotalCost", cost1.ToString());
                         cmd.Parameters.AddWithValue("@recevedFrom", recevedFrom.Text);
                         cmd.Parameters.AddWithValue("@reasonCode", ddlReason.SelectedValue.ToString());
                         cmd.Parameters.AddWithValue("@groupMenuCode", ddlGroupMenu.SelectedValue.ToString());
                         cmd.Parameters.AddWithValue("@offNo", offNo);
...
//              string value  = string.Join(",", columnarray);
        ...
        public void SearchExeedItem()
        {
            ...
            dtGetGroupMEx = itemObject.GetNonVegMainMenu(strConnString, dateSaleDate.SelectedDate.ToString(), ddlReason.SelectedValue.ToString(), wardRoomCode.ToString().Trim(), a.ToString(), ddlVegi.SelectedItem.Text, ddlGroupMenu.SelectedValue.ToString());

            for (int k = 0; k < dtGetGroupMEx.DefaultView.Count; k++)
            {
                float currentQty = float.Parse(dtGetGroupMEx.DefaultView[k].Row["currentStock"].ToString());
                float saleQty = float.Parse(dtGetGroupMEx.DefaultView[k].Row["qty"].ToString());


                if (currentQty < saleQty)
                {
                    grdReport5.Items[k].BackColor = System.Drawing.Color.Orange;
                }
        ...
        protected void grdReport5_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
