...
{
    public partial class DailySummaryByOffNo : System.Web.UI.Page
    {
        ...
        protected void RadButton1_Click(object sender, EventArgs e)
        {
            ...
            command.CommandText = "[VICTULING_GetIndividualMeal_byDaily]";

            command.Parameters.AddWithValue("@wardroomName", Session["wardRoomCode"].ToString());
            command.Parameters.AddWithValue("@date", RadDatePicker1.SelectedDate.ToString());
