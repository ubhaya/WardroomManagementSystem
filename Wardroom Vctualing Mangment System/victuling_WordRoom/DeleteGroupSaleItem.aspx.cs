...
{
    public partial class DeleteGroupSaleItem : System.Web.UI.Page
    {
        ...
        public void getData()
        {
            ...
            command.CommandText = "[VICTULING_GetGroupMenuIngedientList_Delete]";
        ...
        protected void btnViewExtra_Click1(object sender, EventArgs e)
        {
            getData();
        }
    }
