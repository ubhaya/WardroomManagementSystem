...
{
    public partial class ViwIndividualMonthlyPrsonalSale : System.Web.UI.Page
    {
        ...
        protected void btnView_Click(object sender, EventArgs e)
        {
            ...
            command.CommandText = "[VICTULING_GetIndividualPersonal_New]";
            ...
            {
                tot += decimal.Parse(ds.Tables[0].Rows[x][11].ToString());
            }
        ...
        private DataSet SearchTotalMEnuCost(string officialNo, string os, string year, string month, string wardroomCode)
        {
            ...
            cmd = new SqlCommand("[VICTULING_GetIndividualPersonal_New]", con);
