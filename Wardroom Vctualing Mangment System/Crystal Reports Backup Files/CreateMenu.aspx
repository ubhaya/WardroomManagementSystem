<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CreateMenu.aspx.cs" Inherits="victuling_WordRoom.CreateMenu" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table class="style1">
        ...
        <tr>
            ...
            &nbsp;:</td>
            <td class="auto-style1" colspan="2">
                <telerik:RadComboBox ID="cmbItemCategory" runat="server" AutoPostBack="True" OnTextChanged="cmbItemCategory_TextChanged" Width="300px">
                </telerik:RadComboBox>
            </td>
        </tr>
        <tr>
            ...
            &nbsp;:</td>
            <td colspan="2">
                <telerik:RadComboBox ID="cmbItem" runat="server" AutoPostBack="True" 
                    OnTextChanged="cmbItem_TextChanged" Width="300px" Height="22px">
                </telerik:RadComboBox>
