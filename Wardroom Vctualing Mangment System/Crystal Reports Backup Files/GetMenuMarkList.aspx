<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GetMenuMarkList.aspx.cs" Inherits="victuling_WordRoom.GetMenuMarkList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table style="width:100%;">
        <tr>
            <td class="style1">
            <strong>Menu Attendance List</strong></td>
            <td>
                &nbsp;</td>
            <td>
                &nbsp;</td>
