<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddExtraForMenu.aspx.cs" Inherits="victuling_WordRoom.AddExtraForMenu" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <tr>
        <td class="style2" colspan="3">
            <strong>Extra Items For Menu Sale</strong></td>
    </tr>
    <tr>
        <td class="style3">
            &nbsp;</td>
...
<telerik:RadComboBoxItem runat="server" Text="C of N's Party" Value="30000021"></telerik:RadComboBoxItem>
    ...
    <tr>
        ...
        <td>
            <telerik:RadButton ID="btnSearch" runat="server" onclick="btnSearch_Click" 
                Text="Get Hand Stock" Width="117px">
            </telerik:RadButton>
    ...
    <tr>
        <td class="style3">
            &nbsp;</td>
        <td>
            <telerik:RadButton ID="btnSaveExtraCost" runat="server" 
                onclick="btnSaveExtraCost_Click" Text="Save Extra Menu Cost" Width="200px">
            </telerik:RadButton>
        </td>
        <td>
            &nbsp;</td>
