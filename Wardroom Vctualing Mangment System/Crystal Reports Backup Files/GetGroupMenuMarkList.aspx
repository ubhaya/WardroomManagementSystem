<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GetGroupMenuMarkList.aspx.cs" Inherits="victuling_WordRoom.GetGroupMenuMarkList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <tr>
        <td class="style1">
            <strong>Group Menu Attendance List</strong></td>
        <td>
            &nbsp;</td>
        <td>
                &nbsp;</td>
    ...
    <tr>
        <td class="style3">
            Wardroom :</td>
        <td>
            <asp:TextBox ID="txtWardRoom" runat="server" ReadOnly="True"></asp:TextBox>
        </td>
        <td>
                &nbsp;</td>
    </tr>
