                    ...
                    <table style="width:100%;">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:LinkButton ID="lnlRoundOff" runat="server" onclick="lnlRoundOff_Click">Round-Off Value</asp:LinkButton>
                            </td>
                            <td>
                                &nbsp;</td>
                        </tr>
        ...
        <tr>
            ...
            <td>
                <telerik:RadComboBox ID="ddlCreditDebit" Runat="server" 
                    onselectedindexchanged="ddlCreditDebit_SelectedIndexChanged">
                    <Items>
                        <telerik:RadComboBoxItem runat="server" Text="- - Select - -" 
                            Value="- - Select - -" />
