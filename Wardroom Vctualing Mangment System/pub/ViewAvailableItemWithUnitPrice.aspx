<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewAvailableItemWithUnitPrice.aspx.cs" Inherits="victuling_WordRoom.ViewAvailableItemWithUnitPrice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table style="width:100%;">
        <tr>
            <td class="style1">
            <strong>View Available Stock with Price</strong></td>
            <td>
                &nbsp;</td>
            <td>
                &nbsp;</td>
