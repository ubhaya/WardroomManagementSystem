<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddMonthlyTeaCost.aspx.cs" Inherits="victuling_WordRoom.AddMonthlyTeaCost" %>
    ...
    <table style="width:100%;">
        <tr>
            <td class="style1" colspan="3">
                <strong>Add Monthly Tea Cost</strong>
            </td>
        </tr>
        <tr>
            <td class="style2">
        ...
        <tr>
            <td class="style2">
                <asp:Label runat="server" Text="Wardroom  :"></asp:Label>
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <telerik:RadComboBox ID="cmbYear" Runat="server" Width="250px" />
            </td>
            <td>
                &nbsp;
            </td>
        ...
        <tr>
            ...
            <td>
                <telerik:RadComboBox ID="cmbMonth" Runat="server" Width="250px" />
            </td>
            <td>
                &nbsp;
            </td>
        ...
        <tr>
            <td class="style2">
                <asp:Label runat="server" Text="Tea Cost  :"></asp:Label>
            </td>
            <td>
                <telerik:RadNumericTextBox ID="txtTeaCost" Runat="server" Width="245px" InputType="Number" Type="Currency" />
            </td>
            <td>
                &nbsp;
            </td>
        ...
        <tr>
            <td class="style2">
                <asp:Label runat="server" Text="Plain Tea Cost  :"></asp:Label>
            </td>
            <td>
                <telerik:RadNumericTextBox ID="txtPlainTeaCost" Runat="server" Width="245px" InputType="Number" Type="Currency" />
            </td>
            <td>
                &nbsp;
            </td>
        ...
        <tr>
            ...
            <td>
                <telerik:RadButton ID="btnSave" runat="server" onclick="btnSave_Click" 
                    Text="Add Monthly Tea Cost" Width="113px">
                </telerik:RadButton>
            </td>
            <td>
        ...
        <tr>
            <td class="style2">&nbsp;</td>
            <td colspan="2">
                <telerik:RadGrid ID="grdTeaCost" runat="server" AutoGenerateColumns="false">
                    ...
                    <MasterTableView CommandItemDisplay="Top" Width="100%">
                        ...
                        <RowIndicatorColumn FilterControlAltText="Filter Expand Column column" Visible="true" />
                        <ExpandCollapseColumn FilterControlAltText="Filter ExpandColumn column" Visible="True"/>
                        <Columns>
                            <telerik:GridTemplateColumn HeaderText="Sr.No" UniqueName="SrNo">
                                <ItemTemplate>
                                    <asp:Label ID="lblSn" runat="server" />
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridBoundColumn DataField="year" HeaderText="Year" UniqueName="year" />
                            <telerik:GridBoundColumn DataField="month" HeaderText="Month" UniqueName="Month" />
